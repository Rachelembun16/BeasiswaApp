...
<div class="flex-fill d-flex flex-column justify-content-center py-4">
        <div class="container-tight py-6">
            <div class="text-center mb-4">
                ...
                <small class="text-muted">Silahkan untuk menginputkan informasi <strong>dengan data yang benar!</strong></small>
            </div>
            <form action="<?php echo site_url('donatur/simpan_donasi/');?>" method="post">
            ...
            <div class="card-body">
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group input-group-flat">
                        <input name="masuk" type="text" class="form-control" placeholder="Jurusan" autocomplete="off">
                    </div>
                </div>
