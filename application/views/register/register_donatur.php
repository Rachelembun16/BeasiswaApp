...
<?php if (validation_errors()) : ?>
    ...
    <div class="flex-fill d-flex flex-column justify-content-center py-4">
        ...
        <form class="form-signup" action="<?php echo base_url().'index.php/register/validatedonatur'?>" method="post">
            ...
            <div class="card-body">
                <h2 class="card-title text-center mb-4">Daftar Sebagai Donatur</h2>
                <div class="mb-3">
