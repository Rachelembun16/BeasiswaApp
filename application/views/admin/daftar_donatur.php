...
<div class="flex-fill d-flex justify-content-center py-4">
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    <th scope="col">#</th>
                    <th scope="200">Nama Donatur</th>
                    <th scope="col">Email</th>
                    <th width="col">No Hp</th>
                ...
                <tr>
                    ...
                    <td><?php echo $row->no_hp_donatur;?></td>
                    <td><?php echo $row->tgl_lahir_donatur;?></td>
                    <td><?php echo $row->jenis_kelamin_donatur;?></td>
